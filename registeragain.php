...
<script src="https://kit.fontawesome.com/a076d05399.js"></script>
 ...
 <body>
	...
	<form method="post" id="register" action="userregistration.php" method="post" >
	<!---<img src="images/login.png"--->
	<h1>Username Already Exist</h1>
	
	<label>Username:</label><br>
	<input type="text" name="user" id="name" class="input-box" placeholder="Username"><br><br>
	
	<label>Password:</label><br>
	<input type="password" name="password" id="name" class="input-box" placeholder="Password"><br><br>
	
	<label>Department:</label><br>
	<input type="text" name="department" id="num" class="input-box" placeholder="Department"><br><br>
